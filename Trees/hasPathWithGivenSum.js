...
function hasPathWithGivenSum(t, s) {
    ...
    if(t) {
        ...
        if(s === 0 && !(t.left || t.right)) return true;        
        
        let leftResult = false;
        let rightResult = false;

        if(t.left) leftResult = hasPathWithGivenSum(t.left, s);
        if(t.right) rightResult = hasPathWithGivenSum(t.right, s);
...
function hasPathWithGivenSum1(t, s) {
    if(!t) return s === 0;
